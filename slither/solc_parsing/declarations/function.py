...
class FunctionSolc:
    def __init__(
            self, function: Function, function_data: FunctionDefinition, contract_parser: "ContractSolc",
    ):
    ...
    def _new_yul_block(self, src: Union[str, Dict]) -> YulBlock:
        ...
        yul_object = YulBlock(self._function.contract, node,
                              [self._function.name, f"asm_{len(self._node_to_yulobject)}"], parent_func=self._function)
