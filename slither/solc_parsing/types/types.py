...
class ContractDefinition(Declaration):
    ...
    def __init__(self, kind: Optional[str], base: Optional[List[int]], nodes: List[ASTNode], **kwargs):
        super().__init__(**kwargs)
        self.kind = kind
...
class ForStatement(Statement):
    ...
    def __init__(self, init: Statement, cond: 'Expression', loop: 'ExpressionStatement', body: Statement, **kwargs):
        super().__init__(**kwargs)
        self.init = init
        self.cond = cond
        self.loop = loop
